// import Background from '../assets/images/realest.jpg';
// import Background2 from '../assets/images/realest2.jpg';
import './styles.css';

function Owl(props) {
    return (
        <div>
            <div className="owl-carousel owl-single home-slider">
                <div className="item">
                    <div className="untree_co-hero" id="background2">
                        <div className="container">
                            <div className="row align-items-center justify-content-center">
                                <div className="col-lg-8 text-center text-lg-center">
                                    <h1 className="mb-4 heading text-white" data-aos="fade-up" data-aos-delay="100">HELASABILI
                                        MOBILE <a href="https://colorlib/">CAPITAL</a></h1>
                                    <div className="mb-5 text-white desc mx-auto" data-aos="fade-up"
                                         data-aos-delay="200">
                                    </div>
                                    <p className="mb-0" data-aos="fade-up" data-aos-delay="300"><a href="#"
                                                                                                   className="btn btn-outline-black">Explore
                                        now</a></p>
                                    <p className="mt-2 text-white" data-aos="fade-up" data-aos-delay="300"> We specialize in  Real Estate Development</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="item">
                    <div className="untree_co-hero" id="background">
                    </div>
                </div>
            </div>

            <div className="untree_co-section py-4 bg-light">
                <div className="container">
                    <div className="row align-items-stretch">
                        <div className="col-12 col-sm-6 col-md-4 mb-3 mb-md-0">
                            <div className="feature h-100">
                                <div className="icon">
                                    <svg width="1em" height="1em" viewBox="0 0 16 16" className="bi bi-truck"
                        ...
                        <div className="col-12 col-sm-6 col-md-4 mb-3 mb-md-0">
                            <div className="feature h-100">
                                <div className="icon">
                                    <svg width="1em" height="1em" viewBox="0 0 16 16" className="bi bi-shield-lock"
                                         fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                        <path fill-rule="evenodd"
                            ...
                            <div className="feature h-100">
                                <div className="icon">
                                    <svg width="1em" height="1em" viewBox="0 0 16 16"
                                         className="bi bi-arrow-counterclockwise" fill="currentColor"
